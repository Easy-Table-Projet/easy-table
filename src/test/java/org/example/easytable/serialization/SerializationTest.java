...
public class SerializationTest {
    ...
    public void testSerialize() {
        ...
        String json = service.serialize(request);
    ...
    public void testDeserialize() {
        ...
        ReservationCreateReqDto request = service.deserialize(json);
    ...
    public void testSerializeAndDeserialize() throws JsonProcessingException {
        ...
        String json = service.serialize(original);
        ReservationCreateReqDto deserialized = service.deserialize(json);
